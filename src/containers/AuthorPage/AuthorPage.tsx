          ...
          <div className="relative bg-white dark:bg-neutral-900 dark:border dark:border-neutral-700 p-5 lg:p-8 rounded-3xl md:rounded-[40px] shadow-xl flex flex-col md:flex-row">
            ...
            <div className="pt-5 md:pt-1 md:ml-6 xl:ml-14 flex-grow">
              <div className="max-w-screen-sm ">
                ...
                <div className=" w-[40%] flex-1 flex flex-col sm:flex-row items-baseline p-2 mt-7 border-2 border-green-500 rounded-xl relative">
                ...
                <div className="mt-2">
                  <span className="mt-2 py-2 bg-blue-600 rounded-full px-2 text-sm cursor-pointer font-semibold ">
                    Buy token
                  </span>
                </div>
              </div>
