            ...
            <div className=" bg-white dark:bg-neutral-900 h-max  p-0 dark:border dark:border-neutral-700 rounded-3xl md:rounded-[40px] shadow-xl flex flex-col  lg:items-center">
              ...
              `,
               ...
               `,
                  ...
                  {
                    name: " Start Live",
                    icon: `<svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 bg-red-400 rounded-full text-white m-4" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
