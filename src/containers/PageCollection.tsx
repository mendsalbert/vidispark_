    ...
    >
      ...
      <div className="">
        ...
        <main className="flex flex-row w-full justify-between space-x-10">
          ...
          <div className=" bg-white dark:bg-neutral-900 h-max my-8  p-0 dark:border dark:border-neutral-700 rounded-tr-3xl rounded-br-3xl  flex flex-col  lg:items-center">
            <Nav
