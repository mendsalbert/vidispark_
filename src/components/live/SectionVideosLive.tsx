...
const SectionVideosLive: FC<SectionVideosLiveProps> = ({
  ...
  return (
    <div className={`nc-SectionVideos ${className}`}>
      ...
      <div className="flex flex-col relative sm:pr-4 sm:py-4 md:pr-6 md:py-6 xl:pr-14 xl:py-14 lg:flex-row lg:flex-row-reverse">
        ...
        <div className="w-3/12 rounded-3xl bg-primary-100 z-0 sm:rounded-[50px] md:top-0 md:bottom-0 md:right-0 xl:w-7/12 dark:bg-neutral-800/80"></div>
        <div className="flex-grow w-full relative  ">{renderMainVideo()}</div>
